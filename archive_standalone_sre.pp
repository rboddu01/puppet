...
class jboss::archive_standalone_sre (
  ...
  $mod_cluster_config_values          = 'advertise-socket="modcluster" proxies="proxy-one proxy-two " balancer="srecluster" connector="https"',
  $ssl_certificatekey_file            = '"${jboss.server.config.dir}/dhw.jks" ca-certificate-file="${jboss.server.config.dir}/dhw.jks"'
) {
  ...
  #$mod_cluster_config_values = 'advertise-socket="modcluster" proxies="proxy-one proxy-two proxy-three" balancer="srecluster" connector="https"'
  #$mod_cluster_config_values = 'advertise-socket="modcluster" proxies="${mod_cluster_config_proxies}" balancer="srecluster" connector="https"'
